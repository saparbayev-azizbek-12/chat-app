...
urlpatterns = [
    ...
    path('chat/presence/heartbeat/', views.presence_heartbeat, name='presence_heartbeat'),
    path('chat/presence/offline/', views.presence_offline, name='presence_offline'),
    path('chat/<int:conversation_id>/presence/', views.conversation_presence, name='conversation_presence'),
